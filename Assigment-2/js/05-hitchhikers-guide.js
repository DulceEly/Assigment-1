...
let answer=prompt('Have you already played this game before? Please answer yes or no');
if (answer == 'yes')
{
    ...
    let direction=prompt('Which direction would you like to head (please enter between: forward, left, or right).');{
    switch (direction){
        case 'left':
        ...
        let survey= prompt('The game is over. Please give us you rate of this game between 1 and 10');
       if (survey >=6 && survey <= 10){
                    document.write('Thank you for playing this game. We invite you play again.');
                } else if (survey >=1 && survey <= 5){
                    document.write('Thank you for playing this game. We are working hard to improve the game, come back soon!')    
                } else {
                    document.write('Thank you for playing this game!')
                 };

                }else (answer == 'no');{
    document.write('Thank for you interest. Plese play again sometime.')
};
